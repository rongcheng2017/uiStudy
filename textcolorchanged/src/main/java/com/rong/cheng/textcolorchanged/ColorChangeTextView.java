...
public class ColorChangeTextView extends View {
    ...
    public ColorChangeTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initAttr(final Context context, @Nullable final AttributeSet attrs) {
        ...
        mTextSize = ta.getDimensionPixelSize(
                R.styleable.ColorChangeTextView_textSize, mTextSize);
        mTextColor = ta.getColor(
                R.styleable.ColorChangeTextView_textColor, mTextColor);
        mTextColorChange = ta.getColor(
                R.styleable.ColorChangeTextView_textChangeColor, mTextColorChange);
        mProgress = ta.getFloat(R.styleable.ColorChangeTextView_process, 0);

        mDirection = ta
                .getInt(R.styleable.ColorChangeTextView_direction, mDirection);
