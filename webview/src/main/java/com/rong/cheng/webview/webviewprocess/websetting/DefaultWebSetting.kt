package com.rong.cheng.webview.webviewprocess.websetting
...
import com.rong.cheng.webview.BuildConfig

/**
 * @author: frc
 * @description:
 * @date:  2021/6/18 3:09 下午
 *
 */
class DefaultWebSetting private constructor() {
    private lateinit var mWebSettings: WebSettings
    companion object{
        fun newInstance():DefaultWebSetting{
