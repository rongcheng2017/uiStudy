...
import com.rong.cheng.advancedui.skin.SkinViewSupport;
...
/**
 * @author: frc
 * @description: 存放了所有要换肤的view所对应的属性
 * @date: 2021/6/7 6:58 下午
 */
public class SkinAttribute {
    ...
    static class SkinView {
        ...
        public SkinView(View iView, List<SkinPair> iSkinPairs) {
            view = iView;
            skinPairs = iSkinPairs;
        }
    ...
    static class SkinPair {
        ...
        public SkinPair(String iAttributeName, int iResId) {
